...
import { X, Link, Mail, FileSpreadsheet } from "lucide-react";
                ...
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            {/* Tabs */}
                            <div className="flex px-6 pt-6 gap-2 bg-white dark:bg-gray-800">
                                <TabButton
...
function TabButton({ active, onClick, icon, label }: { active: boolean, onClick: () => void, icon: React.ReactNode, label: string }) {
    return (
        <button
            onClick={onClick}
            className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-t-xl text-sm font-medium transition-colors border-b-2 ${active
