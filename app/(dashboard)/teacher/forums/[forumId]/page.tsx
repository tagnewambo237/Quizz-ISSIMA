    ...
    const handleSubmitReply = async (postId: string) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // Optimistically allow user to see the reply immediately via Pusher, 
                // but we also refetch or rely on Pusher
            }
        } catch (err) {
            ...
            <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10 shadow-sm">
                <div className="max-w-3xl mx-auto px-4 py-4">
                    <div className="flex items-center gap-4">
                        <Link href="/teacher/messages?tab=forums" className="p-2 hover:bg-gray-100 rounded-lg">
                                                    ...
                                                    {post.replies?.map((reply) => (
                                                        <div key={reply._id} className="group">
                                                            <div className="flex items-start gap-3">
                                                                <div className="w-6 h-6 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-[10px] font-bold text-gray-600 flex-shrink-0">
