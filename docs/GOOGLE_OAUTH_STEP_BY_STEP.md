...
Guide complet avec captures d'écran pour configurer Google OAuth pour QuizLock.
...
2. Remplissez les informations:
   - **Project name**: `QuizLock` (ou le nom de votre choix)
...
- **Authorized domains**:
  ...
  - En production, ajoutez votre domaine (ex: `quizlock.com`)
...
3. Cliquez sur le nom (ex: "QuizLock Development")
...
Dans votre projet QuizLock, ouvrez ou créez le fichier `.env`:
...
3. Autorisez l'accès à QuizLock
...
### ❌ "Access blocked: QuizLock has not completed the Google verification process"
